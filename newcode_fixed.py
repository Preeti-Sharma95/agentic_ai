...
if st.session_state.data_processed and st.session_state.app_df is not None:
    ...
    if app_mode == "🏦 Dormant Account Analyzer":
        ...
        analysis_options = ["📊 Summarized Dormant Analysis",
                            ...
                            "🏦 Fixed Deposit Agent",
                            "📉 General Inactivity Agent (Savings/Call/Current)",
                            "📵 Unreachable + Marked Dormant Agent"]
...
Executive Summary:"""
            ...
            agent_mapping = {
                ...
                "📉 General Inactivity Agent (Savings/Call/Current)": check_general_inactivity,
                "📵 Unreachable + Marked Dormant Agent": check_unreachable_dormant
            }
